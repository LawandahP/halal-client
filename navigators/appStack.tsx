        ...
        // <NavigationContainer>
            ...
            >
                ...
                <Drawer.Screen name={t('history')} 
                    ...
                    options={{ 
                        drawerIcon: () => (
                            <MaterialIcons name="history" size={20} style={{color: activeColors.light}} />
                        ),
                        headerShown: false 
                    }}  />
                <Drawer.Screen name={t('book')}    
                    ...
                    options={{ 
                        drawerIcon: () => (
                            <Ionicons name="add-circle-outline" size={20} style={{color: activeColors.light}} />
                        ),
                        headerShown: false 
                    }}  />
                ...
                <Drawer.Screen name={t('settings')}  
                    ...
                    options={{ 
                        drawerIcon: () => (
                            <Ionicons name="settings-outline" size={20} style={{color: activeColors.light}} />
                        ),
